...
import type { QnaPostDetail } from '../../model/types';
...
export function QnaContent({
  ...
  const updatedAtStr = new Date(post.updatedAt).toLocaleString('ko-KR', {
    year: 'numeric',
    month: '2-digit',
    day: '2-digit',
    hour: '2-digit',
  ...
  const answerAtStr = post.answerAt
    ? new Date(post.answerAt).toLocaleString('ko-KR', {
        year: 'numeric',
        month: '2-digit',
        day: '2-digit',
        hour: '2-digit',
